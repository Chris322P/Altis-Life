...
if (BTC_active_lift == 1) then
{
	...
	BTC_def_hud       = 1;
	BTC_def_pip       = 1;
	BTC_l_def_veh_pip = ["B_Heli_Transport_01_F","B_Heli_Light_01_F","I_Heli_light_03_unarmed_F"];
	...
	BTC_get_liftable_array =
	{
		...
		{
			//MH9 littlebird
			case "B_Heli_Light_01_F": {_array = ["Quadbike_01_base_F"];};
			//PO-30 orca
			case "O_Heli_Light_02_unarmed_F": {_array = ["Quadbike_01_base_F","Car","Ship"];};
			//UH80 ghosthawk
			case "B_Heli_Transport_01_F": {_array = ["Car","Truck","Air","Ship"];};
			// hellcat
			case "I_Heli_light_03_unarmed_F": {_array = ["Car","Truck","Air","Ship"];};
		};
		_array
	};
};
if (BTC_active_fast_rope == 1) then
{
	...
	BTC_roping_chopper = ["I_Heli_Transport_02_F","O_Heli_Light_02_unarmed_F","B_Heli_Light_01_F","B_Heli_Transport_01_F","I_Heli_light_03_unarmed_F"];
